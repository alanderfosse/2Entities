class ZCL_Z2ENTITIES_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z2ENTITIES_MPC============CP' ##NO_TEXT.
...
CLASS ZCL_Z2ENTITIES_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z2ENTITIES_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'Asso_P_S' "#EC NOTEXT
                            iv_left_type        = 'PRODUCT' "#EC NOTEXT
                            iv_right_type       = 'Supplier' "#EC NOTEXT
                            iv_right_card       = '1' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'Asso_P_SSet'                         "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'WhichSupplier' "#EC NOTEXT
                                                              iv_abap_fieldname = 'FROM_SUPPLIER' "#EC NOTEXT
                                                              iv_association_name = 'Asso_P_S' ). "#EC NOTEXT
lo_nav_property->set_label_from_text_element( iv_text_element_symbol = '001' iv_text_element_container = gc_incl_name ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z2ENTITIES_MPC=>TS_PRODUCT' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z2ENTITIES_MPC=>TS_SUPPLIER' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250225120945'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'WhichSupplier'.                    "#EC NOTEXT
