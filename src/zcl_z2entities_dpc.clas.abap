class ZCL_Z2ENTITIES_DPC definition
  public
...
protected section.
  ...
  methods PRODUCTSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_Z2ENTITIES_MPC=>TS_PRODUCT
    raising
  ...
  methods PRODUCTSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_Z2ENTITIES_MPC=>TT_PRODUCT
  ...
  methods SUPPLIERSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_Z2ENTITIES_MPC=>TS_SUPPLIER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SUPPLIERSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_Z2ENTITIES_MPC=>TT_SUPPLIER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_Z2ENTITIES_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 25.02.2025 13:09:50 in client 001
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_Z2ENTITIES_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA productset_create_entity TYPE zcl_z2entities_mpc=>ts_product.
 DATA supplierset_create_entity TYPE zcl_z2entities_mpc=>ts_supplier.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA productset_get_entity TYPE zcl_z2entities_mpc=>ts_product.
 DATA supplierset_get_entity TYPE zcl_z2entities_mpc=>ts_supplier.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_Z2ENTITIES_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA productset_get_entityset TYPE zcl_z2entities_mpc=>tt_product.
 DATA supplierset_get_entityset TYPE zcl_z2entities_mpc=>tt_supplier.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA productset_update_entity TYPE zcl_z2entities_mpc=>ts_product.
 DATA supplierset_update_entity TYPE zcl_z2entities_mpc=>ts_supplier.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
